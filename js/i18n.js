...
const en = {
  ...
  'lead.eyebrow': 'The People Behind ANSH',
  'lead.heading': 'Founders & Leadership',
  'lead.support': 'The owners and stewards of ANSH ASSOCIATES — and the vision that guides every engagement.',
  'lead.side': 'Vision<br>Ownership<br>Care',
  'lead.foot': 'One firm. One standard. Every client, every time.',

  'lead.1.name': 'Ansh Sharma',
  'lead.1.role': 'Founder & Principal',
  'lead.1.quote': 'I founded ANSH on a simple conviction — a property is not merely an asset, it is the foundation of a family’s future. My vision is a firm that guards that future with diligence, candour and discretion.',
  'lead.2.name': 'Kavita Sharma',
  'lead.2.role': 'Co-Founder & Managing Director',
  'lead.2.quote': 'My vision is simple: every client should feel represented, never processed. We grow one relationship at a time, and we measure success in trust — not transactions.',
  'lead.3.name': 'Rohan Mehta',
  'lead.3.role': 'Head of Investment Advisory',
  'lead.3.quote': 'I see every rupee our clients place with us as a promise. My vision is disciplined, research-first investing that compounds quietly and endures across generations.',
  'lead.4.name': 'Ananya Rao',
  'lead.4.role': 'Director, Client Relations',
  'lead.4.quote': 'My vision is a conversation, not a counter. From the first call to the registered deed, every client deserves to feel heard, guided and celebrated.',
...
const hi = {
  ...
  'lead.eyebrow': 'अंश के पीछे के लोग',
  'lead.heading': 'संस्थापक और नेतृत्व',
  'lead.support': 'अंश एसोसिएट्स के स्वामी और संरक्षक — और वह दृष्टि जो हर कार्य को दिशा देती है।',
  'lead.side': 'दृष्टि<br>स्वामित्व<br>देखभाल',
  'lead.foot': 'एक फ़र्म। एक मानक। हर ग्राहक, हर बार।',

  'lead.1.name': 'अंश शर्मा',
  'lead.1.role': 'संस्थापक और प्रिंसिपल',
  'lead.1.quote': 'मैंने अंश की स्थापना एक सरल विश्वास पर की — संपत्ति केवल एक संपत्ति नहीं, बल्कि परिवार के भविष्य की नींव है। मेरी दृष्टि है एक ऐसी फ़र्म जो उस भविष्य की रक्षा परिश्रम, स्पष्टता और विवेक से करे।',
  'lead.2.name': 'कविता शर्मा',
  'lead.2.role': 'सह-संस्थापक और प्रबंध निदेशक',
  'lead.2.quote': 'मेरी दृष्टि सरल है: हर ग्राहक को प्रतिनिधित्व महसूस हो, कभी प्रक्रिया नहीं। हम एक-एक रिश्ते से बढ़ते हैं, और सफलता को भरोसे में मापते हैं — लेन-देन में नहीं।',
  'lead.3.name': 'रोहन मेहता',
  'lead.3.role': 'निवेश सलाह प्रमुख',
  'lead.3.quote': 'मैं ग्राहकों द्वारा सौंपे हर रुपये को एक वचन मानता हूँ। मेरी दृष्टि है अनुशासित, शोध-प्रथम निवेश जो चुपचाप बढ़ता रहे और पीढ़ियों तक टिका रहे।',
  'lead.4.name': 'अनन्या राव',
  'lead.4.role': 'निदेशक, ग्राहक संबंध',
  'lead.4.quote': 'मेरी दृष्टि है एक संवाद, न कि काउंटर। पहली कॉल से लेकर पंजीकृत विलेख तक, हर ग्राहक को सुना जाना, मार्गदर्शित होना और सम्मानित महसूस करना चाहिए।',
